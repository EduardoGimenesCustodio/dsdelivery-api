...
export class Migration1697384206568 implements MigrationInterface {
  name = 'Migration1697384206568';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "tb_order" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "moment" TIMESTAMP NOT NULL, "status" integer NOT NULL, CONSTRAINT "PK_0ae1adc424fd20d36fe23962c8b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
